    ...
    Calendar.setup({inputField:"patient_missed_date", ifFormat:"%Y-%m-%d", button:"img_curr_date1"});
			...
			<tr>
				<td colspan="3">
					...
					<label><input type="checkbox" name="reason_for[]" value="<?php xl("Patient had MD/medical appointment and not available later in week","e");?>" <?php if(in_array("Patient had MD/medical appointment and not available later in week",$reason_for)) { echo "checked"; }?> ><?php xl("Patient had MD/medical appointment and not available later in week","e");?></label><br>
					<label><input type="checkbox" name="reason_for[]" value="<?php xl("Patient had another appointment and not available later in week","e");?>" <?php if(in_array("Patient had another appointment and not available later in week",$reason_for)) { echo "checked"; }?> ><?php xl("Patient had another appointment and not available later in week","e");?></label><br>
				...
				<td colspan="3">
					<label><input type="checkbox" name="actions_taken[]" value="<?php xl("Clinician unable to reschedule to meet the physician orders for this week, missed visit documented.","e");?>" <?php if(in_array("Clinician unable to reschedule to meet the physician orders for this week, missed visit documented.",$actions_taken)) { echo "checked"; }?> ><?php xl("Clinician unable to reschedule to meet the physician orders for this week, missed visit documented.","e");?></label><br>
