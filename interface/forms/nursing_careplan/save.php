...
careplan_Assess_Vital_Signs ='".$_POST["careplan_Assess_Vital_Signs"]."',
careplan_Assess_Vital_Signs_Specify ='".$_POST["careplan_Assess_Vital_Signs_Specify"]."',
careplan_SN_Skilled_Assessment ='".$_POST["careplan_SN_Skilled_Assessment"]."',
careplan_SN_Skilled_Assessment_Other ='".$_POST["careplan_SN_Skilled_Assessment_Other"]."',
careplan_SN_CARDIO_Assess ='".$_POST["careplan_SN_CARDIO_Assess"]."',
careplan_SN_CARDIO_Assess_Other ='".$_POST["careplan_SN_CARDIO_Assess_Other"]."',
careplan_SN_CARDIO_Teach ='".$_POST["careplan_SN_CARDIO_Teach"]."',
...
careplan_SN_CARDIO_PtPcgGoals ='".$_POST["careplan_SN_CARDIO_PtPcgGoals"]."',
...
careplan_SN_ENDO_Assess ='".$_POST["careplan_SN_ENDO_Assess"]."',
...
careplan_SN_ENDO_PCgGoals ='".$_POST["careplan_SN_ENDO_PCgGoals"]."',
...
careplan_SN_GASTRO_Assess ='".$_POST["careplan_SN_GASTRO_Assess"]."',
careplan_SN_GASTRO_Other ='".$_POST["careplan_SN_GASTRO_Other"]."',
careplan_SN_GASTRO_Teach ='".$_POST["careplan_SN_GASTRO_Teach"]."',
...
careplan_SN_GASTRO_Perform ='".$_POST["careplan_SN_GASTRO_Perform"]."',
...
careplan_SN_GASTRO_PcGoals ='".$_POST["careplan_SN_GASTRO_PcGoals"]."',
careplan_SN_GASTRO_PcGoals_Other ='".$_POST["careplan_SN_GASTRO_PcGoals_Other"]."',
gastro_cal1 ='".$_POST["gastro_cal1"]."',
careplan_SN_GENITO_Assess ='".$_POST["careplan_SN_GENITO_Assess"]."',
careplan_SN_GENITO_Assess_Other ='".$_POST["careplan_SN_GENITO_Assess_Other"]."',
careplan_SN_GENITO_Teach ='".$_POST["careplan_SN_GENITO_Teach"]."',
...
careplan_SN_GENITO_Perform ='".$_POST["careplan_SN_GENITO_Perform"]."',
...
careplan_SN_GENITO_PcgGoals ='".$_POST["careplan_SN_GENITO_PcgGoals"]."',
...
careplan_SN_INTEGU_Assess ='".$_POST["careplan_SN_INTEGU_Assess"]."',
careplan_SN_INTEGU_Assess_Other ='".$_POST["careplan_SN_INTEGU_Assess_Other"]."',
careplan_SN_INTEGU_Teach ='".$_POST["careplan_SN_INTEGU_Teach"]."',
...
careplan_SN_INTEGU_PcgGoals ='".$_POST["careplan_SN_INTEGU_PcgGoals"]."',
...
careplan_SN_MUSCULO_Assess ='".$_POST["careplan_SN_MUSCULO_Assess"]."',
careplan_SN_MUSCULO_Assess_Other ='".$_POST["careplan_SN_MUSCULO_Assess_Other"]."',
careplan_SN_MUSCULO_Teach ='".$_POST["careplan_SN_MUSCULO_Teach"]."',
...
careplan_SN_MUSCULO_PcgGoals ='".$_POST["careplan_SN_MUSCULO_PcgGoals"]."',
...
careplan_SN_MENTAL_Assess ='".$_POST["careplan_SN_MENTAL_Assess"]."',
careplan_SN_MENTAL_Assess_Other ='".$_POST["careplan_SN_MENTAL_Assess_Other"]."',
careplan_SN_MENTAL_Teach ='".$_POST["careplan_SN_MENTAL_Teach"]."',
careplan_SN_MENTAL_Teach_Other ='".$_POST["careplan_SN_MENTAL_Teach_Other"]."',
careplan_SN_MENTAL_PcgGoals ='".$_POST["careplan_SN_MENTAL_PcgGoals"]."',
...
careplan_SN_NEURO_Assess ='".$_POST["careplan_SN_NEURO_Assess"]."',
...
careplan_SN_NEURO_Teach ='".$_POST["careplan_SN_NEURO_Teach"]."',
careplan_SN_NEURO_Teach_Other ='".$_POST["careplan_SN_NEURO_Teach_Other"]."',
careplan_SN_NEURO_PcgGoals ='".$_POST["careplan_SN_NEURO_PcgGoals"]."',
...
careplan_SN_RESPIR_Assess ='".$_POST["careplan_SN_RESPIR_Assess"]."',
careplan_SN_RESPIR_Assess_Other ='".$_POST["careplan_SN_RESPIR_Assess_Other"]."',
careplan_SN_RESPIR_Teach ='".$_POST["careplan_SN_RESPIR_Teach"]."',
...
careplan_SN_RESPIR_PcgGoals ='".$_POST["careplan_SN_RESPIR_PcgGoals"]."',
...
careplan_SN_GENERAL_Assess ='".$_POST["careplan_SN_GENERAL_Assess"]."',
careplan_SN_GENERAL_Assess_Other ='".$_POST["careplan_SN_GENERAL_Assess_Other"]."',
careplan_SN_GENERAL_Teach ='".$_POST["careplan_SN_GENERAL_Teach"]."',
careplan_SN_GENERAL_Teach_Other ='".$_POST["careplan_SN_GENERAL_Teach_Other"]."',
careplan_SN_GENERAL_PcgGoals ='".$_POST["careplan_SN_GENERAL_PcgGoals"]."',
...
wound_label ='".$_POST["wound_label"]."',
wound_value1 ='".$_POST["wound_value1"]."',
wound_value2 ='".$_POST["wound_value2"]."',
wound_value3 ='".$_POST["wound_value3"]."',
wound_value4 ='".$_POST["wound_value4"]."',
wound_value5 ='".$_POST["wound_value5"]."',
wound_value6 ='".$_POST["wound_value6"]."',
wound_value7 ='".$_POST["wound_value7"]."',
wound_value8 ='".$_POST["wound_value8"]."',
