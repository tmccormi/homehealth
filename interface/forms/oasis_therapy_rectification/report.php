...
function oasis_therapy_rectification_report($pid, $encounter, $cols, $id) {
 $count = 0;
 $data = formFetch("forms_oasis_therapy_rectification", $id);
 $chart = 0;
 ...
 if ($data) {
  ...
  if($chart == 1) { 
		...
		/* Render the form. */
		echo $c->report_action($id,'oasis_therapy_rectification');
	}
 } // End of if condition
}
