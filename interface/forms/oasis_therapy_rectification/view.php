...
<input type='text' size='12' name='oasis_therapy_visit_date' id='oasis_therapy_visit_date' value="<?php echo $obj{"oasis_therapy_visit_date"};?>" readonly /> 
	...
	<tr>
		<td>
			<strong><?php xl('<u>(M0100)</u> This Assessment is Currently Being Completed for the Following Reason: <u>Follow-Up</u> ','e');?></strong><br>
				<label><input id="m0100" type="radio" name="oasis_therapy_follow_up" value="4" <?php if($obj{"oasis_therapy_follow_up"}=="4"){echo "checked";}?> ><?php xl(' 4 - Recertification (follow-up) reassessment <strong>[ Go to M0110 ]</strong>','e');?></label><br>
	...
	<tr>
		<td>
			<?php xl('<b><u>(M0110)</u> Episode Timing:</b> Is the Medicare home health payment episode for which this assessment will define a case mix group an "early" episode or a "later" episode in the patient"s current sequence of adjacent Medicare home health payment episodes? ','e');?><br>
				<label><input id="m0110" type="radio" name="oasis_therapy_episode_timing" value="1" <?php if($obj{"oasis_therapy_episode_timing"}=="1"){echo "checked";}?> ><?php xl(' 1 - Early','e');?></label><br>
	...
	<tr>
		<td>
			...
			<input type='text' size='10' name='oasis_therapy_certification_period_from' id='oasis_therapy_certification_period_from' 
					title='<?php xl('Date','e'); ?>' onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc);' value="<?php echo $obj{"oasis_therapy_certification_period_from"};?>" readonly/> 
					<img src='../../pic/show_calendar.gif' align='absbottom' width='24'
			...
			<input type='text' size='10' name='oasis_therapy_certification_period_to' id='oasis_therapy_certification_period_to' 
					title='<?php xl('Date','e'); ?>' onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc);' value="<?php echo $obj{"oasis_therapy_certification_period_to"};?> " readonly/> 
					<img src='../../pic/show_calendar.gif' align='absbottom' width='24'
...
<table style="width:100%;" border="1px" class="formtable">
	...
	<tr>
		<td valign="top" width="50%">
			...
			<label><input id="m1322" type="radio" name="oasis_therapy_current_ulcer_stage1" value="0" <?php if($obj{"oasis_therapy_current_ulcer_stage1"}=="0"){echo "checked";}?> >0</label> 
	...
	<tr>
		...
		<td valign="top">
			...
			<label><input id="m1340" type="radio" name="oasis_therapy_surgical_wound" value="0" <?php if($obj{"oasis_therapy_surgical_wound"}=="0"){echo "checked";}?> ><?php xl(' 0 - No <b>[ Go to M1350 ]</b> ','e')?></label> <br>
...
<table style="width:100%;" border="1px" class="formtable">
	...
	<tr>
		<td>
			...
			<label><input type="checkbox" name="oasis_therapy_urinary[]" value="<?php xl("Diapers/other:","e");?>" <?php if(in_array("Diapers/other:",$oasis_therapy_urinary)) echo "checked"; ?> ><?php xl('Incontinents Pads/other:','e')?></label>
			...
			<?php xl("Date last changed","e");?><br>
				...
				<input type='text' size='10' name='oasis_therapy_urinary_foley_date' id='oasis_therapy_urinary_foley_date' 
						title='<?php xl('Date','e'); ?>' onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc);' value="<?php echo $obj{"oasis_therapy_urinary_foley_date"};?>" readonly/> 
						<img src='../../pic/show_calendar.gif' align='absbottom' width='24'
			...
			<?php xl("<b>Irrigation solution:</b> Type (specify)","e");?>
				...
				<?php xl("Frequency","e");?>
				<input type="text" name="oasis_therapy_urinary_irrigation_frequency" value="<?php echo $obj{"oasis_therapy_urinary_irrigation_frequency"};?>"><br />
			...
			<label><input type="checkbox" name="oasis_therapy_bowels[]" value="Diapers/other" <?php if(in_array("Diapers/other",$oasis_therapy_bowels)) echo "checked"; ?> ><?php xl('Incontinents Pads/other:','e')?></label>
				<input type="text" name="oasis_therapy_bowels_diapers_others" value="<?php echo $obj{"oasis_therapy_bowels_diapers_others"};?>"><br>
			<label><input type="checkbox" name="oasis_therapy_bowels[]" value="Ileostomy/colostomy" <?php if(in_array("Ileostomy/colostomy",$oasis_therapy_bowels)) echo "checked"; ?> ><?php xl('Ileostomy/colostomy site:','e')?></label><br>
			...
			<label><input type="checkbox" name="oasis_therapy_bowels[]" value="Other site" <?php if(in_array("Other site",$oasis_therapy_bowels)) echo "checked"; ?> ><?php xl('Other site:','e')?></label><br>
			...
			<label><input type="checkbox" name="oasis_therapy_bowels[]" value="Urostomy" <?php if(in_array("Urostomy",$oasis_therapy_bowels)) echo "checked"; ?> ><?php xl('Urostomy:','e')?></label><br>
		...
		<td valign="top">
			...
			<label><input id="m1620" type="radio" name="oasis_therapy_elimination_bowel_incontinence" value="0" <?php if($obj{"oasis_therapy_elimination_bowel_incontinence"}=="0"){echo "checked";}?> ><?php xl(' 0 - Very rarely or never has bowel incontinence','e')?></label> <br>
...
<table style="width:100%;" border="1px" class="formtable">
	<tr>
		<td colspan="2">
			...
			<label><input type="checkbox" name="oasis_therapy_summary_check_medication" value="completed" <?php if($obj{"oasis_therapy_summary_check_medication"}=="completed"){echo "checked";}?> ><?php xl('Medication regimen completed/reviewed','e')?></label>
			...
			<input type='text' size='10' name='oasis_therapy_summary_check_next_visit' id='oasis_therapy_summary_check_next_visit' 
						title='<?php xl('Date','e'); ?>' onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc);' value="<?php echo $obj{"oasis_therapy_summary_check_next_visit"};?>" readonly/> 
						<img src='../../pic/show_calendar.gif' align='absbottom' width='24'
			...
			<label><input type="radio" name="oasis_therapy_summary_check_verbal_order" value="Yes" <?php if($obj{"oasis_therapy_summary_check_verbal_order"}=="Yes"){echo "checked";}?> ><?php xl(' Yes, specify date','e')?></label><br>
...
<a id="btn_save" href="javascript:top.restoreSession();form_validation('oasis_therapy_rectification');" class="link_submit" onClick="return requiredCheck()"><?php xl(' [Save]','e')?></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
