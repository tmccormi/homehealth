...
$encounter = date("Ymd");
if ($_GET["mode"] == "new"){
$newid = formSubmit("forms_oasis_therapy_rectification", $addnew, $_GET["id"], $userauthorized);
addForm($encounter, "OASIS Recert-PT", $newid,'oasis_therapy_rectification', $pid, $userauthorized);




$table_name="forms_oasis_therapy_rectification";
$form_id = $newid;
...
$query = mysql_query("select column_name from information_schema.columns where table_name = 'forms_oasis_therapy_rectification'");
...
sqlInsert("update forms_oasis_therapy_rectification set". implode(",", $search_qry) ." where id=$id");
}
