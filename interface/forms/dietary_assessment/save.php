...
dietary_assessment_dob ='".implode("#",$_POST["dietary_assessment_dob"])."',
...
dietary_assessment_stage_ulcers ='".implode("#",$_POST["dietary_assessment_stage_ulcers"])."',
...
dietary_assessment_past_food_drink ='".implode("#",$_POST["dietary_assessment_past_food_drink"])."',
...
dietary_assessment_rd_signature_date ='".implode("#",$_POST["dietary_assessment_rd_signature_date"])."',
