...
spouse_significant_others_row1='".implode("#",$_POST["spouse_significant_others_row1"])."',
spouse_significant_others_row2='".implode("#",$_POST["spouse_significant_others_row2"])."',
spouse_significant_others_row3='".implode("#",$_POST["spouse_significant_others_row3"])."',
caregivers_row1='".implode("#",$_POST["caregivers_row1"])."',
caregivers_row2='".implode("#",$_POST["caregivers_row1"])."',
...
patient_needs_help_with  ='".implode("#",$_POST["patient_needs_help_with"])."',
...
medical_social_services_interventions  ='".implode("#",$_POST["medical_social_services_interventions"])."',
...
physician_order  ='".implode("#",$_POST["physician_order"])."',
