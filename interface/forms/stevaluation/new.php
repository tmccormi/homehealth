  ...
  <tr>
	...
	<td width="6%"><strong><?php xl('Time In','e'); ?></strong></td>
        ...
        <td width="6%"><select name="Evaluation_Time_Out" id="Evaluation_Time_Out"> <?php timeDropDown($GLOBALS['Selected']) ?></select></td>
          <td width="5%" align="center"><strong><?php xl('Encounter Date','e')?></strong></td><td>
...
&lt; <?php xl('90% after rest','e')?></strong>  
  ...
  <tr>
	...
	<input type="text" id="Evaluation_Reason_for_intervention" name="Evaluation_Reason_for_intervention" style="width:100%;"/>
          ...
          <td align="center">
	<input type="text" id="Evaluation_TREATMENT_DX_Problem" name="Evaluation_TREATMENT_DX_Problem" style="width:100%;"/>
	</td>
        </tr>
      </table>
  </tr>
