...
Evaluation_VS_BP_Body_side ='".$_POST["Evaluation_VS_BP_Diastolic"]."',
Evaluation_VS_BP_Body_Position='".$_POST["Evaluation_VS_BP_Body_side"]."',
...
Evaluation_COG_Oriented_Type='".$_POST["Evaluation_COG_Alert_type"]."',
