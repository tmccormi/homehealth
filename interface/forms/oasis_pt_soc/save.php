...
$encounter = date("Ymd");
if ($_GET["mode"] == "new"){
$newid = formSubmit("forms_oasis_pt_soc", $addnew, $_GET["id"], $userauthorized);
addForm($encounter, "OASIS SOC/ROC-PT", $newid,'oasis_pt_soc', $pid, $userauthorized);





$table_name="forms_oasis_pt_soc";
$form_id = $newid;
...
$query = mysql_query("select column_name from information_schema.columns where table_name = 'forms_oasis_pt_soc'");
...
sqlInsert("update forms_oasis_pt_soc set". implode(",", $search_qry) ." where id=$id");
}
