...
careplan_Treatment_Plan_Duration ='".$_POST["careplan_Treatment_Plan_Duration"]."',
careplan_Treatment_Plan_Freq_Duration1='".$_POST["careplan_Treatment_Plan_Freq_Duration1"]."',
careplan_Treatment_Plan_Freq_Duration2='".$_POST["careplan_Treatment_Plan_Freq_Duration2"]."',
