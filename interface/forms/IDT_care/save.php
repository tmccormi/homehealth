...
idt_care_care_coordination_involved_discipline ='".implode("#",$_POST["idt_care_care_coordination_involved_discipline"])."',
...
idt_care_topic_for_discussion ='".implode("#",$_POST["idt_care_topic_for_discussion"])."',
