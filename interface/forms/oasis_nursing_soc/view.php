...
$formTable = "forms_oasis_nursing_soc";
...
$oasis_professional_vital_parameter = explode("#",$obj{"oasis_professional_vital_parameter"});
$oasis_professional_sn_parameters = explode("#",$obj{"oasis_professional_sn_parameters"});
$oasis_professional_sn_frequency = explode("#",$obj{"oasis_professional_sn_frequency"});
$oasis_professional_goals = explode("#",$obj{"oasis_professional_goals"});
$oasis_professional_sn_provide = explode("#",$obj{"oasis_professional_sn_provide"});
$oasis_professional_teaching_activities = explode("#",$obj{"oasis_professional_teaching_activities"});
$oasis_professional_skilled_nurse1 = explode("#",$obj{"oasis_professional_skilled_nurse1"});
$oasis_professional_skilled_nurse2 = explode("#",$obj{"oasis_professional_skilled_nurse2"});
$oasis_professional_sn_nurse = explode("#",$obj{"oasis_professional_sn_nurse"});
$oasis_professional_sn_nurse1 = explode("#",$obj{"oasis_professional_sn_nurse1"});
$oasis_professional_sn_nurse2 = explode("#",$obj{"oasis_professional_sn_nurse2"});
	...
	<tr>
		...
		<td valign="top">
			...
			<strong><?php xl('Certification:','e');?></strong><br>
				<label><input type="radio" name="oasis_patient_certification" value="0" <?php if($obj{"oasis_patient_certification"}=="0"){echo "checked";}?> ><?php xl(' Certification','e');?></label>
				<label><input type="radio" name="oasis_patient_certification" value="1" <?php if($obj{"oasis_patient_certification"}=="1"){echo "checked";}?> ><?php xl(' Recertification','e');?></label>
			<hr>
	...
	<tr>
		<td valign="top">
			...
			<strong><?php xl('<u>(M0100)</u> This Assessment is Currently Being Completed for the Following Reason: <br><u>Start/Resumption of Care</u> ','e');?></strong><br>
				<label><input type="radio" id="m0100" name="oasis_patient_follow_up" value="1" <?php if($obj{"oasis_patient_follow_up"}=="1"){echo "checked";}?> ><?php xl(' 1 - Start of care-further visits planned','e');?></label><br>
		...
		<td>
			...
			<?php xl('<b><u>(M0110)</u> Episode Timing:</b> Is the Medicare home health payment episode for which this assessment will define a case mix group an "early" episode or a "later" episode in the patient"s current sequence of adjacent Medicare home health payment episodes? ','e');?><br>
				<label><input type="radio" id="m0110" name="oasis_patient_episode_timing" value="1" <?php if($obj{"oasis_patient_episode_timing"}=="1"){echo "checked";}?> ><?php xl(' 1 - Early','e');?></label><br>
		...
		<td valign="top">
			...
			<table class="formtable" border="0px" width="100%">
				...
				<tr>
					<td>
						<?php xl('a.','e'); ?>&nbsp;
							<input type="text" id="m1016" style="width:80%" name="oasis_patient_history_mrd_diagnosis[]" id="oasis_patient_history_mrd_diagnosis1" value="<?php echo $oasis_patient_history_mrd_diagnosis[0]; ?>" />
							<br>
						<?php xl('b.','e'); ?>&nbsp;
...
<table style="width:100%;" border="1px" class="formtable">
	...
	<tr>
		<td valign="top">
			...
			<label><input type="radio" id="m1306" name="oasis_pressure_ulcer_unhealed_s2" value="0" <?php if($obj{"oasis_pressure_ulcer_unhealed_s2"}=="0"){echo "checked";}?> ><?php xl(' 0 - No <b><i>[ Go to M1322 ]</i></b>','e')?></label><br>
...
<label>
<input type="checkbox" name="oasis_infusion[]" value="NA"  id="oasis_infusion"  <?php if(in_array("NA",$oasis_infusion)) echo "checked"; ?> />
<?php xl('NA','e')?></label> &nbsp;
</center>
<label>
<input type="checkbox" name="oasis_infusion[]" value="Peripheral: (specify)"  id="oasis_infusion"  <?php if(in_array("Peripheral: (specify)",$oasis_infusion)) echo "checked"; ?> />
<strong><?php xl('Peripheral: (specify)','e')?></strong></label> &nbsp;
<input type="text" name="oasis_infusion_peripheral" id="oasis_infusion_peripheral" size="25"  value="<?php echo stripslashes($obj{"oasis_infusion_peripheral"});?>" /><br />
<label>
<input type="checkbox" name="oasis_infusion[]" value="PICC: (specify, size, brand)"  id="oasis_infusion"  <?php if(in_array("PICC: (specify, size, brand)",$oasis_infusion)) echo "checked"; ?> />
<strong><?php xl('PICC: (specify, size, brand)','e')?></strong></label> &nbsp;
<input type="text" name="oasis_infusion_PICC" id="oasis_infusion_PICC" size="25"  value="<?php echo stripslashes($obj{"oasis_infusion_PICC"});?>"  /><br />
<label>
<input type="checkbox" name="oasis_infusion[]" value="Central"  id="oasis_infusion"  <?php if(in_array("Central",$oasis_infusion)) echo "checked"; ?> /><?php xl('Central','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion[]" value="Midline/Midclavicular"  id="oasis_infusion"  <?php if(in_array("Midline/Midclavicular",$oasis_infusion)) echo "checked"; ?> /><?php xl('Midline/Midclavicular','e')?></label><br />
&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="oasis_infusion_central" value="Single lumen"  id="oasis_infusion_central"  <?php if($obj{"oasis_infusion_central"}=="Single lumen") echo "checked"; ?> />
<?php xl('Single lumen','e')?></label> &nbsp;
<label><input type="radio" name="oasis_infusion_central" value="Double lumen"  id="oasis_infusion_central"  <?php if($obj{"oasis_infusion_central"}=="Double lumen") echo "checked"; ?> />
<?php xl('Double lumen','e')?></label> &nbsp;
<label><input type="radio" name="oasis_infusion_central" value="Triple lumen"  id="oasis_infusion_central"  <?php if($obj{"oasis_infusion_central"}=="Triple lumen") echo "checked"; ?> />
...
<?php xl('Date of placement:','e')?><input type='text' size='10' name='oasis_infusion_central_date' id='oasis_infusion_central_date'
                        title='<?php xl('yyyy-mm-dd Visit Date','e'); ?>' onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc);' 
                         value="<?php echo stripslashes($obj{"oasis_infusion_central_date"});?>" 
                        readonly/>
                        <img src='../../pic/show_calendar.gif' align='absbottom' width='24'
...
<br />
<label>
<input type="checkbox" name="oasis_infusion[]" value="X-ray verification:"  id="oasis_infusion"  <?php if(in_array("X-ray verification:",$oasis_infusion)) echo "checked"; ?> />
<strong><?php xl('X-ray verification:','e')?></strong></label> &nbsp;
<label><input type="radio" name="oasis_infusion_xray" value="Yes"  id="oasis_infusion_xray"  <?php if($obj{"oasis_infusion_xray"}=="Yes") echo "checked"; ?> />
<?php xl('Yes','e')?></label> &nbsp;
<label><input type="radio" name="oasis_infusion_xray" value="No"  id="oasis_infusion_xray"  <?php if($obj{"oasis_infusion_xray"}=="No") echo "checked"; ?> />
<?php xl('No','e')?></label> &nbsp;

<br />
<label>
<input type="checkbox" name="oasis_infusion[]" value="Mid arm circumference in/cm"  id="oasis_infusion"  <?php if(in_array("Mid arm circumference in/cm",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Mid arm circumference in/cm','e')?></label> &nbsp;
<input type="text" name="oasis_infusion_circum" id="oasis_infusion_circum" size="25" value="<?php echo stripslashes($obj{"oasis_infusion_circum"});?>"  /><br />
<label>
<input type="checkbox" name="oasis_infusion[]" value="External catheter length in/cm"  id="oasis_infusion"  <?php if(in_array("External catheter length in/cm",$oasis_infusion)) echo "checked"; ?> />
<?php xl('External catheter length in/cm','e')?></label> &nbsp;
<input type="text" name="oasis_infusion_length" id="oasis_infusion_length" size="25" value="<?php echo stripslashes($obj{"oasis_infusion_length"});?>"  /><br />
<br />

<label>
<input type="checkbox" name="oasis_infusion[]" value="Hickman"  id="oasis_infusion"  <?php if(in_array("Hickman",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Hickman','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion[]" value="Broviac"  id="oasis_infusion"  <?php if(in_array("Broviac",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Broviac','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion[]" value="Groshong"  id="oasis_infusion"  <?php if(in_array("Groshong",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Groshong','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion[]" value="Jugular"  id="oasis_infusion"  <?php if(in_array("Jugular",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Jugular','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion[]" value="Subclavian"  id="oasis_infusion"  <?php if(in_array("Subclavian",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Subclavian','e')?></label> &nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
<label><input type="radio" name="oasis_infusion_hickman" value="Single lumen"  id="oasis_infusion_hickman"  <?php if($obj{"oasis_infusion_hickman"}=="Single lumen") echo "checked"; ?> />
<?php xl('Single lumen','e')?></label> &nbsp;
<label><input type="radio" name="oasis_infusion_hickman" value="Double lumen"  id="oasis_infusion_hickman" <?php if($obj{"oasis_infusion_hickman"}=="Double lumen") echo "checked"; ?>  />
<?php xl('Double lumen','e')?></label> &nbsp;
<label><input type="radio" name="oasis_infusion_hickman" value="Triple lumen"  id="oasis_infusion_hickman" <?php if($obj{"oasis_infusion_hickman"}=="Triple lumen") echo "checked"; ?>  />
<?php xl('Triple lumen','e')?></label> &nbsp;
<br />
<?php xl('Date of placement:','e')?><input type='text' size='10' name='oasis_infusion_hickman_date' id='oasis_infusion_hickman_date'
                        title='<?php xl('yyyy-mm-dd Visit Date','e'); ?>' onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc);'
                         value="<?php echo stripslashes($obj{"oasis_infusion_hickman_date"});?>" 
                        readonly/>
                        <img src='../../pic/show_calendar.gif' align='absbottom' width='24'
...
<label>
<input type="checkbox" name="oasis_infusion[]" value="Epidural catheter"  id="oasis_infusion" <?php if(in_array("Epidural catheter",$oasis_infusion)) echo "checked"; ?>  />
<?php xl('Epidural catheter','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion[]" value="Tunneled"  id="oasis_infusion"  <?php if(in_array("Tunneled",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Tunneled','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion[]" value="Port1"  id="oasis_infusion"  <?php if(in_array("Port1",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Port','e')?></label> &nbsp;
<br />

<?php xl('Date of placement:','e')?><input type='text' size='10' name='oasis_infusion_epidural_date' id='oasis_infusion_epidural_date'
                        title='<?php xl('yyyy-mm-dd Visit Date','e'); ?>' onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc);' 
                         value="<?php echo stripslashes($obj{"oasis_infusion_epidural_date"});?>" 
                        readonly/>
                        <img src='../../pic/show_calendar.gif' align='absbottom' width='24'
...
<label>
<input type="checkbox" name="oasis_infusion[]" value="Implanted VAD"  id="oasis_infusion"  <?php if(in_array("Implanted VAD",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Implanted VAD','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion[]" value="Venous"  id="oasis_infusion"  <?php if(in_array("Venous",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Venous','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion[]" value="Arterial"  id="oasis_infusion"  <?php if(in_array("Arterial",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Arterial','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion[]" value="Peritoneal"  id="oasis_infusion"  <?php if(in_array("Peritoneal",$oasis_infusion)) echo "checked"; ?> />
...
<?php xl('Date of placement:','e')?><input type='text' size='10' name='oasis_infusion_implanted_date' id='oasis_infusion_implanted_date'
                        title='<?php xl('yyyy-mm-dd Visit Date','e'); ?>' onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc);' 
                         value="<?php echo stripslashes($obj{"oasis_infusion_implanted_date"});?>" 
                        readonly/>
                        <img src='../../pic/show_calendar.gif' align='absbottom' width='24'
...
<label>
<input type="checkbox" name="oasis_infusion[]" value="Intrathecal"  id="oasis_infusion"  <?php if(in_array("Intrathecal",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Intrathecal','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion[]" value="Port2"  id="oasis_infusion"  <?php if(in_array("Port2",$oasis_infusion)) echo "checked"; ?> />
<?php xl('Port','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion[]" value="Reservoir"  id="oasis_infusion"  <?php if(in_array("Reservoir",$oasis_infusion)) echo "checked"; ?> />
...
<?php xl('Date of placement:','e')?><input type='text' size='10' name='oasis_infusion_intrathecal_date' id='oasis_infusion_intrathecal_date'
                        title='<?php xl('yyyy-mm-dd Visit Date','e'); ?>' onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc);' 
                         value="<?php echo stripslashes($obj{"oasis_infusion_intrathecal_date"});?>" 
                        readonly/>
                        <img src='../../pic/show_calendar.gif' align='absbottom' width='24'
...
<label>
<input type="checkbox" name="oasis_infusion[]" value="Medication administered1"  id="oasis_infusion"  <?php if(in_array("Medication administered1",$oasis_infusion)) echo "checked"; ?> />
<strong><?php xl('Medication(s) administered:','e')?></strong></label> &nbsp;
<input type="text" name="oasis_infusion_med1_admin" id="oasis_infusion_med1_admin" size="25" value="<?php echo stripslashes($obj{"oasis_infusion_med1_admin"});?>"  />
<br />
<label><?php xl('(name of drug)','e')?> &nbsp;
<input type="text" name="oasis_infusion_med1_name" id="oasis_infusion_med1_name" size="25" value="<?php echo stripslashes($obj{"oasis_infusion_med1_name"});?>"  /><br />
</label>
<label><?php xl('Dose','e')?> &nbsp;
<input type="text" name="oasis_infusion_med1_dose" id="oasis_infusion_med1_dose" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med1_dose"});?>"  />
</label>
<label><?php xl('Dilution','e')?> &nbsp;
<input type="text" name="oasis_infusion_med1_dilution" id="oasis_infusion_med1_dilution" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med1_dilution"});?>"  />
</label>
<label><?php xl('Route','e')?> &nbsp;
<input type="text" name="oasis_infusion_med1_route" id="oasis_infusion_med1_route" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med1_route"});?>"  /><br />
</label>
<label><?php xl('Frequency','e')?> &nbsp;
<input type="text" name="oasis_infusion_med1_frequency" id="oasis_infusion_med1_frequency" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med1_frequency"});?>"  />
</label>
<label><?php xl('Duration of therapy','e')?> &nbsp;
<input type="text" name="oasis_infusion_med1_duration" id="oasis_infusion_med1_duration" size="10"  value="<?php echo stripslashes($obj{"oasis_infusion_med1_duration"});?>" />
</label>
...
<label>
<input type="checkbox" name="oasis_infusion[]" value="Medication administered2"  id="oasis_infusion"  <?php if(in_array("Medication administered2",$oasis_infusion)) echo "checked"; ?> />
<strong><?php xl('Medication(s) administered:','e')?></strong></label> &nbsp;
<input type="text" name="oasis_infusion_med2_admin" id="oasis_infusion_med2_admin" size="25"  value="<?php echo stripslashes($obj{"oasis_infusion_med2_admin"});?>" />
<br />
<label><?php xl('(name of drug)','e')?> &nbsp;
<input type="text" name="oasis_infusion_med2_name" id="oasis_infusion_med2_name" size="25"  value="<?php echo stripslashes($obj{"oasis_infusion_med2_name"});?>" /><br />
</label>
<label><?php xl('Dose','e')?> &nbsp;
<input type="text" name="oasis_infusion_med2_dose" id="oasis_infusion_med2_dose" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med2_dose"});?>"  />
</label>
<label><?php xl('Dilution','e')?> &nbsp;
<input type="text" name="oasis_infusion_med2_dilution" id="oasis_infusion_med2_dilution" size="10"  value="<?php echo stripslashes($obj{"oasis_infusion_med2_dilution"});?>" />
</label>
<label><?php xl('Route','e')?> &nbsp;
<input type="text" name="oasis_infusion_med2_route" id="oasis_infusion_med2_route" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med2_route"});?>"  /><br />
</label>
<label><?php xl('Frequency','e')?> &nbsp;
<input type="text" name="oasis_infusion_med2_frequency" id="oasis_infusion_med2_frequency" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med2_frequency"});?>"  />
</label>
<label><?php xl('Duration of therapy','e')?> &nbsp;
<input type="text" name="oasis_infusion_med2_duration" id="oasis_infusion_med2_duration" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med2_duration"});?>"  />
</label>
...
<label>
<input type="checkbox" name="oasis_infusion[]" value="Medication administered3"  id="oasis_infusion"  <?php if(in_array("Medication administered3",$oasis_infusion)) echo "checked"; ?> />
<strong><?php xl('Medication(s) administered:','e')?></strong></label> &nbsp;
<input type="text" name="oasis_infusion_med3_admin" id="oasis_infusion_med3_admin" size="25"  value="<?php echo stripslashes($obj{"oasis_infusion_med3_admin"});?>" />
<br />
<label><?php xl('(name of drug)','e')?> &nbsp;
<input type="text" name="oasis_infusion_med3_name" id="oasis_infusion_med3_name" size="25"  value="<?php echo stripslashes($obj{"oasis_infusion_med3_name"});?>" /><br />
</label>
<label><?php xl('Dose','e')?> &nbsp;
<input type="text" name="oasis_infusion_med3_dose" id="oasis_infusion_med3_dose" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med3_dose"});?>"  />
</label>
<label><?php xl('Dilution','e')?> &nbsp;
<input type="text" name="oasis_infusion_med3_dilution" id="oasis_infusion_med3_dilution" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med3_dilution"});?>"  />
</label>
<label><?php xl('Route','e')?> &nbsp;
<input type="text" name="oasis_infusion_med3_route" id="oasis_infusion_med3_route" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med3_route"});?>"  /><br />
</label>
<label><?php xl('Frequency','e')?> &nbsp;
<input type="text" name="oasis_infusion_med3_frequency" id="oasis_infusion_med3_frequency" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med3_frequency"});?>"  />
</label>
<label><?php xl('Duration of therapy','e')?> &nbsp;
<input type="text" name="oasis_infusion_med3_duration" id="oasis_infusion_med3_duration" size="10" value="<?php echo stripslashes($obj{"oasis_infusion_med3_duration"});?>"  />
</label>
<br />
<label>
<input type="checkbox" name="oasis_infusion[]" value="Pump:(type, specify)"  id="oasis_infusion"  <?php if(in_array("Pump:(type, specify)",$oasis_infusion)) echo "checked"; ?> />
<strong><?php xl('Pump:(type, specify)','e')?></strong></label> &nbsp;
<input type="text" name="oasis_infusion_pump" id="oasis_infusion_pump" size="25" value="<?php echo stripslashes($obj{"oasis_infusion_pump"});?>"  />
<br />
<strong><?php xl('Administered by:','e')?></strong>
<label>
<input type="checkbox" name="oasis_infusion_admin_by" value="Self"  id="oasis_infusion_admin_by"  <?php if($obj{"oasis_infusion_admin_by"}=="Self") echo "checked"; ?> />
<?php xl('Self','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion_admin_by" value="Caregiver"  id="oasis_infusion_admin_by"  <?php if($obj{"oasis_infusion_admin_by"}=="Caregiver") echo "checked"; ?> />
<?php xl('Caregiver','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion_admin_by" value="RN"  id="oasis_infusion_admin_by"  <?php if($obj{"oasis_infusion_admin_by"}=="RN") echo "checked"; ?> />
<?php xl('RN','e')?></label> &nbsp;
<label><br />
<input type="checkbox" name="oasis_infusion_admin_by" value="Other"  id="oasis_infusion_admin_by" <?php if($obj{"oasis_infusion_admin_by"}=="Other") echo "checked"; ?>  />
<?php xl('Other','e')?></label> &nbsp;
<input type="text" name="oasis_infusion_admin_by_other" id="oasis_infusion_admin_by_other"  width="40"  value="<?php echo stripslashes($obj{"oasis_infusion_admin_by_other"});?>"  />
<br />
<label>
<input type="checkbox" name="oasis_infusion[]" value="Dressing change:"  id="oasis_infusion"  <?php if(in_array("Dressing change:",$oasis_infusion)) echo "checked"; ?> />
<strong><?php xl('Dressing change:','e')?></strong></label> &nbsp;
<label><input type="radio" name="oasis_infusion_dressing" value="Sterile"  id="oasis_infusion_dressing"  <?php if($obj{"oasis_infusion_dressing"}=="Sterile") echo "checked"; ?> />
<?php xl('Sterile','e')?></label> &nbsp;
<label><input type="radio" name="oasis_infusion_dressing" value="Clean"  id="oasis_infusion_dressing" <?php if($obj{"oasis_infusion_dressing"}=="Clean") echo "checked"; ?>  />
<?php xl('Clean','e')?></label> &nbsp;
<br />

<strong><?php xl('Performed by:','e')?></strong> &nbsp;&nbsp;&nbsp;&nbsp;
<label>
<input type="checkbox" name="oasis_infusion_performed_by" value="Self"  id="oasis_infusion_performed_by"  <?php if($obj{"oasis_infusion_performed_by"}=="Self") echo "checked"; ?> />
<?php xl('Self','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion_performed_by" value="RN"  id="oasis_infusion_performed_by"  <?php if($obj{"oasis_infusion_performed_by"}=="RN") echo "checked"; ?> />
<?php xl('RN','e')?></label> &nbsp;
<label>
<input type="checkbox" name="oasis_infusion_performed_by" value="Caregiver"  id="oasis_infusion_performed_by"  <?php if($obj{"oasis_infusion_performed_by"}=="Caregiver") echo "checked"; ?> />
<?php xl('Caregiver','e')?></label> &nbsp;
<br />
<label>
<input type="checkbox" name="oasis_infusion_performed_by" value="Other"  id="oasis_infusion_performed_by"  <?php if($obj{"oasis_infusion_performed_by"}=="Other") echo "checked"; ?> />
<?php xl('Other','e')?></label> &nbsp;
<input type="text" name="oasis_infusion_performed_by_other" id="oasis_infusion_performed_by_other" size="30" value="<?php echo stripslashes($obj{"oasis_infusion_performed_by_other"});?>"  />
<br />

<label><?php xl('Frequency (specify)','e')?> &nbsp;
<input type="text" name="oasis_infusion_frequency" id="oasis_infusion_frequency" size="30" value="<?php echo stripslashes($obj{"oasis_infusion_frequency"});?>"  />
</label>
<br />
<label><?php xl('Injection cap change (specify frequency)','e')?> &nbsp;
<input type="text" name="oasis_infusion_injection" id="oasis_infusion_injection" size="20" value="<?php echo stripslashes($obj{"oasis_infusion_injection"});?>"  />
</label>
<br />
<label><?php xl('Labs drawn','e')?> &nbsp;
<br />
<textarea name="oasis_infusion_labs_drawn" rows="2" cols="48"><?php echo stripslashes($obj{"oasis_infusion_labs_drawn"});?></textarea>
</label>
...
<strong><?php xl("<u>(M1910)</u>","e");?></strong>
			...
			<label><input type="radio" id="m2010" name="oasis_adl_patient_caregiver" value="0" <?php if($obj{"oasis_adl_patient_caregiver"}=="0") echo "checked"; ?> ><?php xl(' 0 - No','e')?></label> <br>
...
<td>
<label><input type="radio" id="m2040" name="oasis_adl_func_oral_med" value="0" <?php if($obj{"oasis_adl_func_oral_med"}=="0") echo "checked"; ?> ><?php xl(' 0','e')?></label> <br>
</td>
<td>
...
<tr valign="top">
	...
	<td>
	<input type="text" name="oasis_professional_880"  value="<?php echo stripslashes($obj{"oasis_professional_880"});?>"  size="3">
	<?php xl('> or <','e')?><input type="text" name="oasis_professional_88"  value="<?php echo stripslashes($obj{"oasis_professional_88"});?>"  size="3">
	</td>
	</tr>
...
<td>
<label><input type="checkbox" name="oasis_professional_skilled_nurse1[]" value="PORT-A-CATH CARE" <?php if(in_array("4",$oasis_professional_skilled_nurse1)) echo "checked"; ?> >
...
<tr>
<td colspan="2">
<textarea name="oasis_additional_notes" rows="10" cols="98">
<?php echo stripslashes($obj{"oasis_additional_notes"});?>
</textarea><br>
</td>
</tr>
