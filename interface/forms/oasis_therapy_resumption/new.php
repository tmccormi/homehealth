...
formHeader("Form: oasis_therapy_resumption");
...
<html>
<head>
<title>Oasis Therapy Resumption</title>
<style type="text/css">
.bold {
	font-weight: bold;
}
...
<body>
<form method="post"
		action="<?php echo $rootdir;?>/forms/oasis_therapy_resumption/save.php?mode=new" name="oasis_therapy_resumption">
	...
	<tr>
		...
		<td>
			...
			<?php
                ...
                $c = new C_FormPainMap('oasis_therapy_resumption','bodymap_man.png');
...
<strong><?php xl("<u>(M1910)</u>","e");?></strong>
			...
			<label><input type="radio" name="oasis_adl_patient_caregiver" value="0"><?php xl(' 0 - No','e')?></label> <br>
...
<td>
<label><input type="radio" name="oasis_adl_func_oral_med" value="0"><?php xl(' 0','e')?></label> <br>
</td>
<td>
...
<a id="btn_save" href="javascript:top.restoreSession();document.oasis_therapy_resumption.submit();"
