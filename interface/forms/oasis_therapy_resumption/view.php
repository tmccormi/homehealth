...
$formTable = "forms_oasis_therapy_resumption";
...
<body class="body_top">
<?php
$obj = formFetch("forms_oasis_therapy_resumption", $_GET["id"]);
...
$oasis_dme_foley_supplies = explode("#",$obj{"oasis_dme_wound_care"});
...
<form method="post"
		action="<?php echo $rootdir;?>/forms/oasis_therapy_resumption/save.php?mode=update&id=<?php echo $_GET["id"];?>" name="oasis_therapy_resumption">
...
<table style="width:100%;" border="1px" class="formtable">
	...
	<tr>
		...
		<td valign="top">
			...
			<input type="text" name="oasis_patient_medicare_no" value="<?php echo $obj{"oasis_patient_medicare_no"};?>"><br>
