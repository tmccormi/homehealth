...
dischargeplan_Pain='".$_POST["dischargeplan_Pain"]."',
dischargeplan_Vital_Signs_Pain  ='".$_POST["dischargeplan_Vital_Signs_Pain"]."',
dischargeplan_Vital_Signs_Location  ='".$_POST["dischargeplan_Vital_Signs_Location"]."',
...
dischargeplan_at_time_of_discharge ='".$_POST["dischargeplan_at_time_of_discharge"]."',
...
dischargeplan_md_signature_date ='".$_POST["dischargeplan_md_signature_date"]."'
where id=$id");
}
