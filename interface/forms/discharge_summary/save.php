...
discharge_summary_discontinue_services ='".implode("#",$_POST["discharge_summary_discontinue_services"])."',
...
discharge_summary_provided_interventions ='".implode("#",$_POST["discharge_summary_provided_interventions"])."',
discharge_summary_provided_interventions_other ='".$_POST["discharge_summary_provided_interventions_other"]."',
discharge_summary_discharge_reason ='".implode("#",$_POST["discharge_summary_discharge_reason"])."',
