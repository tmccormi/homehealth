...
home_environment_action_plan_1 ='".implode("#",$_POST["home_environment_action_plan_1"])."',
home_environment_action_plan_2 ='".implode("#",$_POST["home_environment_action_plan_2"])."',
home_environment_action_plan_3 ='".implode("#",$_POST["home_environment_action_plan_3"])."',
home_environment_action_plan_4 ='".implode("#",$_POST["home_environment_action_plan_4"])."',
home_environment_action_plan_5 ='".implode("#",$_POST["home_environment_action_plan_5"])."',
home_environment_action_plan_6 ='".implode("#",$_POST["home_environment_action_plan_6"])."',
home_environment_action_plan_7 ='".implode("#",$_POST["home_environment_action_plan_7"])."',
home_environment_action_plan_8 ='".implode("#",$_POST["home_environment_action_plan_8"])."',
home_environment_action_plan_9 ='".implode("#",$_POST["home_environment_action_plan_9"])."',
home_environment_action_plan_10 ='".implode("#",$_POST["home_environment_action_plan_10"])."',
home_environment_action_plan_11 ='".implode("#",$_POST["home_environment_action_plan_11"])."',
home_environment_action_plan_12 ='".implode("#",$_POST["home_environment_action_plan_12"])."',
home_environment_action_plan_13 ='".implode("#",$_POST["home_environment_action_plan_13"])."',
home_environment_action_plan_14 ='".implode("#",$_POST["home_environment_action_plan_14"])."',
home_environment_action_plan_15 ='".implode("#",$_POST["home_environment_action_plan_15"])."',
home_environment_action_plan_16 ='".implode("#",$_POST["home_environment_action_plan_16"])."',
home_environment_action_plan_17 ='".implode("#",$_POST["home_environment_action_plan_17"])."',
home_environment_improve_safety ='".implode("#",$_POST["home_environment_improve_safety"])."',
