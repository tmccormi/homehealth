...
<input type="text" id="dischargeplan_treatment_diagnosis_problem" name="dischargeplan_treatment_diagnosis_problem" style="width:100%;" value="<?php echo stripslashes($obj{'dischargeplan_treatment_diagnosis_problem'}); ?>"/></td>
  </tr>
  <tr>
