...
<input type='text' size='12' name='SOC_Date' id='SOC_Date' title='<?php xl('Start of Care Date','e'); ?>' onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc);' value="<?php echo stripslashes($obj{"SOC_Date"});?>" readonly/>
