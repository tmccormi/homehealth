...
<td><input type='text' size='10' name='msw_evaluation_soc' id='msw_evaluation_soc' title='<?php xl('yyyy-mm-dd Date of Birth','e'); ?>'
value="<?php echo stripslashes($obj{"msw_evaluation_soc"});?>"
				onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc);' readonly /> 
					<img src='../../pic/show_calendar.gif' align='absbottom' width='24'
