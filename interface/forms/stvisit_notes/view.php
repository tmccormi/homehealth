...
<?php xl('Visit and Supervisory Visit Other','e'); ?> 
<input type="text" size="30px" name="visitnote_Type_of_Visit_Other" id="visitnote_Type_of_Visit_Other" 
...
&nbsp;&nbsp;&nbsp;<?php xl('Other','e'); ?>
<input type="text" name="visitnote_Interventions_Other" size="25px" id="visitnote_Interventions_Other" value="<?php echo stripslashes($obj{"visitnote_Interventions_Other"});?>" >
</strong>
<br /></td>
  </tr>
  <tr>
    <td valign="top" scope="row"><table width="100%" border="1" cellpadding="2px">
      <tr valign="top">
        ...
        <td>
          <p><?php xl('Other','e'); ?>
              <textarea rows="6" cols="30" name="visitnote_Other1" size="35px" id="visitnote_Other1"><?php echo stripslashes($obj{"visitnote_Other1"});?></textarea>
          </p></td>
      </tr>
    </table></td>
  </tr>
    ...
    <td scope="row"><table width="100%" border="0px" cellpadding="2px" class="formtable">
        <tr>
          ...
          <td align="left" scope="row">
            ...
            <input type="text" size="15%" name="visitnote_Improved_Oral_Stage_In" value="<?php echo stripslashes($obj{"visitnote_Improved_Oral_Stage_In"});?>" id="visitnote_Improved_Oral_Stage_In" />
            ...
            <input type="text" size="15%" name="visitnote_Improved_Pharyngeal_Stage_In" value="<?php echo stripslashes($obj{"visitnote_Improved_Pharyngeal_Stage_In"});?>" id="visitnote_Improved_Pharyngeal_Stage_In" />
	    ...
	    <input type="checkbox" name="visitnote_Improved_Verbal_Expression"  <?php if ($obj{"visitnote_Improved_Verbal_Expression"} == "on"){echo "checked";};?> id="visitnote_Improved_Verbal_Expression" />
            ...
            <input type="text" name="visitnote_Improved_Verbal_Expression_In" size="15%" value="<?php echo stripslashes($obj{"visitnote_Improved_Verbal_Expression_In"});?>" id="visitnote_Improved_Verbal_Expression_In" />
            ...
            <input type="text" name="visitnote_Improved_Non_Verbal_Expression_In" size="15%" value="<?php echo stripslashes($obj{"visitnote_Improved_Non_Verbal_Expression_In"});?>" id="visitnote_Improved_Non_Verbal_Expression_In" />
	    ...
	    <br/>
	      ...
	      id="visitnote_Improved_Comprehension" />
            ...
            <input type="text" name="visitnote_Improved_Comprehension_In" size="60%" value="<?php echo stripslashes($obj{"visitnote_Improved_Comprehension_In"});?>" id="visitnote_Improved_Comprehension_In" />
	    ...
	    <br/>
            ...
            <input type="text" name="visitnote_Caregiver_Family_Performance_In" size="60%" value="<?php echo stripslashes($obj{"visitnote_Caregiver_Family_Performance_In"});?>" id="visitnote_Caregiver_Family_Performance_In" />
	    ...
	    <input type="text" name="visitnote_Functional_Improvements_Other_Note" size="60%" id="visitnote_Functional_Improvements_Other_Note" value="<?php echo stripslashes($obj{"visitnote_Functional_Improvements_Other_Note"});?>" />

	    <br/>
           <?php xl('Additional Comments Regarding Discharge Status of Patient','e');?>
            <input type="text" name="visitnote_FI_Additional_Comments" size="40%" value="<?php echo stripslashes($obj{"visitnote_FI_Additional_Comments"});?>" id="visitnote_FI_Additional_Comments" />
          </p></td>
