...
<input type="text" size="50px" name="visitnote_TOV_Visit_Other" id="visitnote_TOV_Visit_Other" /></td>
  </tr>
  <tr>
    ...
    <td valign="top" scope="row"><table width="100%" border="1" cellpadding="2px">
      <tr valign="top">
        ...
        <td>
          ...
          <p><?php xl('Other','e'); ?>
            <input type="text" name="visitnote_Interventions_Other1" size="35px" id="visitnote_Interventions_Other1" />
          </p></td>
      </tr>
    </table></td>
  </tr>
...
<?php xl('ADL','e'); ?> 
<input type="text" size="25px" name="visitnote_Functional_Improvement_ADL_Notes" id="visitnote_Functional_Improvement_ADL_Notes" />
...
<?php xl('Performance of Home Exercises for','e'); ?>
 ...
 <br /> 
 <?php xl('Other','e'); ?>
<input type="text" size="150px" name="visitnote_Functional_Improvement_Other" id="visitnote_Functional_Improvement_Other" /></td>
  </tr>
  <tr>
