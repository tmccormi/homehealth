...
oasis_c_nurse_payment_source_homecare varchar(150) DEFAULT NULL,
...
oasis_c_nurse_stage2_col1 varchar(150) DEFAULT NULL,
oasis_c_nurse_stage2_col2 varchar(150) DEFAULT NULL,
oasis_c_nurse_stage3_col1 varchar(150) DEFAULT NULL,
oasis_c_nurse_stage3_col2 varchar(150) DEFAULT NULL,
oasis_c_nurse_stage4_col1 varchar(150) DEFAULT NULL,
oasis_c_nurse_stage4_col2 varchar(150) DEFAULT NULL,
oasis_c_nurse_non_removable_col1 varchar(150) DEFAULT NULL,
oasis_c_nurse_non_removable_col2 varchar(150) DEFAULT NULL,
oasis_c_nurse_coverage_col1 varchar(150) DEFAULT NULL,
oasis_c_nurse_coverage_col2 varchar(150) DEFAULT NULL,
oasis_c_nurse_suspected_col1 varchar(150) DEFAULT NULL,
oasis_c_nurse_suspected_col2 varchar(150) DEFAULT NULL,
...
oasis_c_nurse_vital_sign_respiratory_rate varchar(150) DEFAULT NULL,	
...
oasis_c_nurse_breath_sounds_o2_saturation varchar(150) DEFAULT NULL,
oasis_c_nurse_breath_sounds_accessory_muscle varchar(150) DEFAULT NULL,
...
oasis_c_nurse_breath_sounds_accessory_lpm varchar(150) DEFAULT NULL,
...
oasis_c_nurse_breath_sounds_other varchar(150) DEFAULT NULL,
oasis_c_nurse_heart_sounds_type varchar(50) DEFAULT NULL,
oasis_c_nurse_heart_sounds text,
oasis_c_nurse_heart_sounds_pacemaker varchar(150) DEFAULT NULL,
oasis_c_nurse_heart_sounds_pacemaker_date date default NULL,
oasis_c_nurse_heart_sounds_pacemaker_type varchar(150) DEFAULT NULL,
...
oasis_c_nurse_heart_sounds_other varchar(150) DEFAULT NULL,
oasis_c_nurse_weight_variation varchar(150) DEFAULT NULL,
...
oasis_c_nurse_urinary_incontinence varchar(150) DEFAULT NULL,
oasis_c_nurse_urinary_management_strategy varchar(150) DEFAULT NULL,
oasis_c_nurse_urinary_diapers_other varchar(150) DEFAULT NULL,
oasis_c_nurse_urinary_color varchar(75) DEFAULT NULL,
oasis_c_nurse_urinary_color_other varchar(150) DEFAULT NULL,
oasis_c_nurse_urinary_clarity varchar(50) DEFAULT NULL,
oasis_c_nurse_urinary_odor varchar(10) DEFAULT NULL,
oasis_c_nurse_urinary_catheter varchar(150) DEFAULT NULL,
oasis_c_nurse_urinary_foley_date date default NULL,
oasis_c_nurse_urinary_foley_ml varchar(150) DEFAULT NULL,
oasis_c_nurse_urinary_irrigation_solution varchar(150) DEFAULT NULL,
oasis_c_nurse_urinary_irrigation_amount varchar(150) DEFAULT NULL,
oasis_c_nurse_urinary_irrigation_ml varchar(150) DEFAULT NULL,
oasis_c_nurse_urinary_irrigation_frequency varchar(150) DEFAULT NULL,
oasis_c_nurse_urinary_irrigation_returns varchar(150) DEFAULT NULL,
oasis_c_nurse_urinary_tolerated_procedure varchar(50) DEFAULT NULL,
oasis_c_nurse_urinary_other varchar(150) DEFAULT NULL,
oasis_c_nurse_bowels_problem varchar(20) DEFAULT NULL,
oasis_c_nurse_bowels text,
oasis_c_nurse_bowel_regime varchar(150) DEFAULT NULL,
oasis_c_nurse_bowels_lexative_enema varchar(20) DEFAULT NULL,
oasis_c_nurse_bowels_lexative_enema_other varchar(150) DEFAULT NULL,
oasis_c_nurse_bowels_incontinence varchar(150) DEFAULT NULL,
oasis_c_nurse_bowels_diapers_others varchar(150) DEFAULT NULL,
...
oasis_c_nurse_activities_permitted_other varchar(150) DEFAULT NULL,
oasis_c_nurse_medication varchar(10) DEFAULT NULL,
oasis_c_nurse_therapy_need_number varchar(150) DEFAULT NULL,
...
oasis_c_nurse_fall_risk_assessment_total varchar(150) DEFAULT NULL,
oasis_c_nurse_fall_risk_assessment_comments text,
oasis_c_nurse_enteral text,
oasis_c_nurse_enteral_other varchar(150) DEFAULT NULL,
oasis_c_nurse_enteral_pump varchar(150) DEFAULT NULL,
oasis_c_nurse_enteral_feedings varchar(30) DEFAULT NULL,
oasis_c_nurse_enteral_rate varchar(150) DEFAULT NULL,
...
oasis_c_nurse_infusion_circum varchar(150) DEFAULT NULL,
oasis_c_nurse_infusion_length varchar(150) DEFAULT NULL,
...
oasis_c_nurse_homebound_reason_other varchar(150) DEFAULT NULL,
...
oasis_c_nurse_summary_check_carecordination_other varchar(150) DEFAULT NULL,
oasis_c_nurse_summary_check_referrel varchar(150) DEFAULT NULL,
...
oasis_c_nurse_dme_wound_care_other varchar(150) DEFAULT NULL,
oasis_c_nurse_dme_diabetic text,
oasis_c_nurse_dme_diabetic_other varchar(150) DEFAULT NULL,
oasis_c_nurse_dme_iv_supplies text,
oasis_c_nurse_dme_iv_supplies_other varchar(150) DEFAULT NULL,
oasis_c_nurse_dme_foley_supplies text,
oasis_c_nurse_dme_foley_supplies_other varchar(150) DEFAULT NULL,
oasis_c_nurse_dme_urinary text,
oasis_c_nurse_dme_ostomy_pouch_brand varchar(150) DEFAULT NULL,
oasis_c_nurse_dme_ostomy_pouch_size varchar(150) DEFAULT NULL,
oasis_c_nurse_dme_ostomy_wafer_brand varchar(150) DEFAULT NULL,
oasis_c_nurse_dme_ostomy_wafer_size varchar(150) DEFAULT NULL,
oasis_c_nurse_dme_urinary_other varchar(150) DEFAULT NULL,
...
oasis_c_nurse_dme_miscellaneous_other varchar(150) DEFAULT NULL,
oasis_c_nurse_dme_supplies text,
oasis_c_nurse_dme_supplies_other varchar(150) DEFAULT NULL,
oasis_c_nurse_safety_measures text,
oasis_c_nurse_safety_measures_other varchar(150) DEFAULT NULL,
oasis_c_nurse_nutritional_requirement text,
oasis_c_nurse_nutritional_requirement_other varchar(150) DEFAULT NULL,
oasis_c_nurse_allergies text,
oasis_c_nurse_nutritional_allergies_other varchar(150) DEFAULT NULL,
oasis_c_nurse_functional_limitations text,
oasis_c_nurse_functional_limitations_other varchar(150) DEFAULT NULL,
oasis_c_nurse_mental_status text,
oasis_c_nurse_mental_status_other varchar(150) DEFAULT NULL,
oasis_c_nurse_discharge_plan text,
oasis_c_nurse_discharge_plan_other varchar(150) DEFAULT NULL,
oasis_c_nurse_discharge_plan_detail text,
oasis_c_nurse_discharge_plan_detail_other varchar(150) DEFAULT NULL
) engine=MyISAM;
