...
<input type="text" size="12" name="oasis_c_nurse_visit_date" id="oasis_c_nurse_visit_date" value="<?php VisitDate(); ?>" readonly>
...
<hr />
			<strong><?php xl('(M0080) Discipline of Person Completing Assessment:','e');?></strong><br />
				<label><input type="radio" name="oasis_c_nurse_discipline_person" value="1" checked><?php xl(' 1 - RN ','e');?></label>
...
<u><b><?php xl('Follow-Up ','e');?></b></u><br />
				<label><input id="m0100" type="radio" name="oasis_c_nurse_follow_up" value="4" checked><?php xl(' 4 - Recertification (follow-up) reassessment <strong>[Go to M0110]</strong>','e');?></label><br />
...
<hr />
			<strong><?php xl('(M0110) Episode Timing:','e') ?></strong><?php xl(' Is the Medicare home health payment episode for which this assessment will define a case mix group an "early" episode or a "later" episode in the patient"s current sequence of adjacent Medicare home health payment episodes? ','e');?><br />
				<label><input id="m0110" type="radio" name="oasis_c_nurse_episode_timing" value="1" checked><?php xl(' 1 - Early','e');?></label><br />
...
<hr />
			...
			<strong><?php xl('Certification:','e');?></strong><br>
				<label><input type="radio" name="oasis_c_nurse_certification" value="0" checked ><?php xl(' Certification','e');?></label>
				<label><input type="radio" name="oasis_c_nurse_certification" value="1"><?php xl(' Recertification','e');?></label>
			<hr>
		...
		<td colspan="2">
			<table border="1px" cellspacing="0" class="formtable">
				...
				<tr>
					...
					<td>
						<?php xl('m. ','e');?>
						<input type="text" name="oasis_patient_diagnosis_2m" id="oasis_patient_diagnosis_2m" size="15" value="" size="18" onkeydown="fonChange(this,2,'all')">
...
<tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<label><input type="radio" name="oasis_c_nurse_vision" value="0" checked><?php xl(' 0 - Normal vision: sees adequately in most situations; can see medication labels, newsprint.','e')?></label><br />
	...
	<tr valign="top">
		...
		<td>
			...
			<label><input type="radio" name="oasis_c_nurse_frequency_pain" value="0" checked><?php xl(' 0 - Patient has no pain','e')?></label><br />
...
<tr>
	...
	<tr>
		<td width="50%">
			...
			<label><input id="m1322" type="radio" name="oasis_c_nurse_current_ulcer_stage1" value="0" checked>0</label> 
			...
			<label><input type="radio" name="oasis_c_nurse_statis_ulcer" value="0" checked><?php xl(' 0 - No <b>[Go to M1340]</b> ','e')?></label> <br>
		...
		<td>
			...
			<label><input id="m1340" type="radio" name="oasis_c_nurse_surgical_wound" value="0" checked><?php xl(' 0 - No <b>[Go to M1350]</b> ','e')?></label> <br>
...
<strong><?php xl('Edema:','e')?></strong></label><br />
	...
	<tr>
		<td colspan="2">
			...
			<label><input type="radio" name="oasis_c_nurse_respiratory_status" value="0" checked><?php xl(' 0 - Patient is not short of breath ','e')?></label> <br>
...
<br /><?php xl("<b>Urinary Catheter:</b> Type (specify)","e");?>
		...
		<td>
			...
			<label><input type="radio" name="oasis_c_nurse_elimination_urinary_incontinence" value="0" checked><?php xl(' 0 - No incontinence or catheter (includes anuria or ostomy for urinary drainage) <b>[Go to M1620]</b> ','e')?></label> <br>
			...
			<label><input id="m1620" type="radio" name="oasis_c_nurse_elimination_bowel_incontinence" value="0" checked><?php xl(' 0 - Very rarely or never has bowel incontinence','e')?></label> <br>
			...
			<label><input type="radio" name="oasis_c_nurse_elimination_ostomy" value="0" checked><?php xl(' 0 - Patient does <u>not</u> have an ostomy for bowel elimination. ','e')?></label> <br>
...
<table width="100%" border="1px" class="formtable">
	...
	<tr valign="top">
		<td width="50%">
			...
			<label><input type="radio" name="oasis_c_nurse_adl_dress_upper" value="0" checked><?php xl(' 0 - Able to get clothes out of closets and drawers, put them on and remove them from the  upper body without assistance. ','e')?></label> <br>
			...
			<label><input type="radio" name="oasis_c_nurse_adl_dress_lower" value="0" checked><?php xl(' 0 - Able to obtain, put on, and remove clothing and shoes without assistance.','e')?></label> <br>
			...
			<label><input type="radio" name="oasis_c_nurse_adl_wash" value="0" checked><?php xl(' 0 - Able to bathe self in <u>shower or tub</u> independently, including getting in and out of tub/shower.','e')?></label> <br>
...
(c) for washing difficult to reach areas.','e')?></label> <br>
			...
			<label><input type="radio" name="oasis_c_nurse_adl_toilet_transfer" value="0" checked><?php xl(' 0 - Able to get to and from the toilet and transfer independently with or without a device.','e')?></label> <br>
...
<td>
			...
			<label><input type="radio" name="oasis_c_nurse_adl_transferring" value="0" checked><?php xl(' 0 - Able to independently transfer.','e')?></label> <br>
			...
			<label><input type="radio" name="oasis_c_nurse_adl_ambulation" value="0" checked><?php xl(' 0 - Able to independently walk on even and uneven surfaces and negotiate stairs with or without railings (i.e., needs no human assistance or assistive device).','e')?></label> <br>
