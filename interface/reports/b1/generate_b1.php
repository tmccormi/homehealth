...
while ($row1 = mysql_fetch_array($result1)) {
  ...
  if ($table_name == 'forms_oasis_nursing_soc' || $table_name == 'forms_oasis_nursing_resumption' || $table_name == 'forms_oasis_pt_soc') {
	  if ($row1['oasis_patient_patient_gender'] == 'male') {$gender = '1';
	  } else {$gender = '2';
	  }
  } else if ($table_name == 'forms_OASIS') {
	  if ($row1['OASIS_C_patient_gender'] == 'Male') {$gender = '1';
	  } else {$gender = '2';
	  }
  } else if ($table_name == 'forms_oasis_discharge'||$table_name == 'forms_oasis_therapy_rectification') {
	  if ($row1['oasis_therapy_patient_gender'] == 'Male') {$gender = '1';
	  } else {$gender = '2';
	  }
  } else if ($table_name == 'forms_oasis_c_nurse') {
	  if ($row1['oasis_c_nurse_patient_gender'] == 'male') {$gender = '1';
	  } else {$gender = '2';
	  }
  } else {$gender = ' ';
  }
  ...
  if ($table_name == 'forms_oasis_nursing_soc' || $table_name == 'forms_oasis_pt_soc') {$therapy_need_no_of_visits = $row1['oasis_care_therapy_visits'];
  } else if ($table_name == 'forms_OASIS') {$therapy_need_no_of_visits = $row1['OASIS_C_Therapy_Need'];
  } else if ($table_name == 'forms_oasis_c_nurse') {$therapy_need_no_of_visits = $row1['oasis_c_nurse_therapy_need_number'];
  } else if ($table_name == 'forms_oasis_therapy_rectification') {$therapy_need_no_of_visits = $row1['oasis_therapy_therapy_need_number'];
  ...
  if ($table_name == 'forms_oasis_nursing_soc' || $table_name == 'forms_oasis_nursing_resumption' || $table_name == 'forms_oasis_pt_soc') {
	  ...
	  } else {$patient_living_situation = '0' . $row1['oasis_living_arrangements_situation'];
	  }
