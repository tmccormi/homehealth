...
$('#form_hospital_name').change(function(){
   var id=  $(this).val();
    $.ajax({
    url: 'new_comprehensive_ajax.php?hospitalID='+id,
    dataType: 'json',
...
$('#form_agency_name').change(function(){
   var agid=  $(this).val();
    $.ajax({
    url: 'new_comprehensive_ajax.php?agencyID='+agid,
    dataType: 'json',
    success: function(data) {     
...
$('#form_ref_providerID').change(function(){
   var agid=  $(this).val();
    $.ajax({
    url: 'new_comprehensive_ajax.php?refProviderID='+agid,
    dataType: 'json',
    success: function(data) {     
...
$('#form_other_physician').change(function(){
   var agid=  $(this).val();
    $.ajax({
    url: 'new_comprehensive_ajax.php?otPhyID='+agid,
    dataType: 'json',
    success: function(data) {     
...
$('#form_attending_physician1').change(function(){
   var agid=  $(this).val();
    $.ajax({
    url: 'new_comprehensive_ajax.php?attPhyID='+agid,
    dataType: 'json',
    success: function(data) {     
