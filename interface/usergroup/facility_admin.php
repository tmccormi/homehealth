	...
	?>
	 ...
	 <tr>
	  ...
	  <td>[<a href="javascript:void(0);" onClick="pick('pick','newcolor');return false;" NAME="pick" ID="pick"><?php  echo htmlspecialchars(xl('Pick'),ENT_QUOTES); ?></a>]</td><td>&nbsp;</td>
        ...
        <tr>
            <td><span class="text"><?php xl('Synergy ID','e'); ?>:</span></td>
            <td colspan="4"><input type="text" name="synergy_id" size="20" value="<?php echo htmlspecialchars($facility['synergy_id'], ENT_QUOTES) ?>"></td>
        </tr>
